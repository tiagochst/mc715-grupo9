...
%%% CAPA %%%
\title{Fase 2 - Implementação de Eleição}                                
...
\begin{frame}[fragile=singleslide]
  \frametitle{Líder caiu?}
  \begin{exampleblock}{Election.java}
%    \begin{lstlisting}[basicstyle=\tiny]
\lstinputlisting[label=sched.c,basicstyle=\tiny]{process.java}
...
\begin{frame}[fragile=singleslide]
  \frametitle{Líder atual é atualizado}
  \begin{exampleblock}{Election.java}
    \begin{lstlisting}
...
\begin{frame}[fragile=singleslide]
  \frametitle{Esperando líder cair}
  \begin{exampleblock}{Election.java}
    \begin{lstlisting}
      public void run() {
        try {
...
\begin{frame}[fragile=singleslide]
  \frametitle{Inserindo znode efêmero na disputa pela liderança}
  \begin{exampleblock}{Election.java}
    \begin{lstlisting}
...
\begin{frame}[fragile=singleslide]
  \frametitle{Quantos clientes estão querendo ser líder}
  \begin{exampleblock}{Election.java}
    \begin{lstlisting}
...
\begin{frame}[fragile=singleslide]
  \frametitle{Monitoração do znode}
  \begin{exampleblock}{Election.java}
    \begin{lstlisting}
...
\begin{frame}[fragile=singleslide]
  \frametitle{Criação de znode e espera pela queda do líder}
  \begin{exampleblock}{Election.java}
    \begin{lstlisting}[basicstyle=\tiny]
